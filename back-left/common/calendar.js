    ...
    gCalFlow.prototype.opts = {
      ...
      date_formatter: function(d, allday_p) {
        ...
        if ((typeof Globalize !== "undefined" && Globalize !== null) && (Globalize.format != null)) {
          ...
          if (allday_p) {
            return (month[d.getMonth() + 1]) + "-" + (pad_zero(d.getDate())) + "-" + (d.getFullYear());
          } else {
            return (month[d.getMonth() + 1]) + "-" + (pad_zero(d.getDate())) + "-" + (d.getFullYear()) + " " + (this.time_formatter(d, this.hours_fmt));
          }
        }
      },
        time_formatter: function(d, fmt) {
        var hours, mins;
        if (fmt == null) {
          fmt = 24;
        }
      ...
      daterange_formatter: function(sd, ed, allday_p) {
        ...
        if (sd.getDate() !== ed.getDate() || sd.getMonth() !== ed.getMonth()) {
          if ((typeof Globalize !== "undefined" && Globalize !== null) && (Globalize.format != null)) {
            ...
            endstr += " " + (this.time_formatter(ed, this.hours_fmt));
          }
        }
